...
class MyBookDetailsWidget extends StatefulWidget {
  const MyBookDetailsWidget({
    Key key,
    this.bookDetails,
  }) : super(key: key);
  ...
  @override
  _MyBookDetailsWidgetState createState() => _MyBookDetailsWidgetState();
}

class _MyBookDetailsWidgetState extends State<MyBookDetailsWidget> {
